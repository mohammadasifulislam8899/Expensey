...
data class UpdateProfileParams(val fullName: String, val currencyCode: String)
...
class UpdateProfileUseCase(
    ...
    override suspend fun invoke(params: UpdateProfileParams): Result<User, DataError> {
        ...
        return repository.updateProfile(params.fullName.trim(), params.currencyCode.trim())
    }
}
