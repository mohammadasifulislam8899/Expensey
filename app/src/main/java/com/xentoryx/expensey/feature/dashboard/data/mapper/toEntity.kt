...
fun AccountSummaryResponseDto.toEntity(syncStatus: SyncStatus = SyncStatus.SYNCED) = AccountEntity(
    accountId = accountId,
    accountName = accountName,
    accountType = accountType,
    balance = balance,
...
fun TransactionResponseDto.toEntity(syncStatus: SyncStatus = SyncStatus.SYNCED) = TransactionEntity(
    id = id,
    userId = userId,
    accountId = accountId,
    categoryId = categoryId,
